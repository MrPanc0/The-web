...
const translations = {
    cs: {
        ...
        galleryTitle: "Naše práce", faqTitle: " QAN ", faqQ1: "Jak dlouho trvá výroba?", faqA1: "Zdarma vám do 24 hodin zašleme reálný odhad ceny.<br>Po potvrzení objednávky odesíláme hotový produkt do 2–4 pracovních dnů. U složitějších či větších projektů se může dodací lhůta lišit.", faqQ2: "Jaké jsou maximální rozměry tisku?", faqA2: "Náš největší tiskový objem je 350 x 350 x 350 mm. Větší předměty by se po dohodě tiskly po dílech.", faqQ3: "Můžete mi pomoci s návrhem modelu?", faqA3: "Model dokážeme vytvořit podle technického výkresu nebo fotografie (ideálně doplněné o rozměry).", faqQ4: "Jak chráníte mé modely před zneužitím nebo únikem dat?", faqA4: "Vaše duševní vlastnictví je u nás chráněno. Příprava tisku probíhá na vyhrazeném offline počítači a samotné tiskárny jsou fyzicky odpojeny od internetu.", footerDesc: "Profesionální zakázkový 3D tisk a modelování.", contactTitle: "Kontakt", socialTitle: "Sledujte nás",
    ...
    en: {
        ...
        galleryTitle: "Our Work", faqTitle: "FAQ", faqQ1: "How long does production take?", faqA1: "We’ll send you a realistic price estimate within 24 hours, free of charge.<br>Once your order is confirmed, we ship the finished product within 2–4 business days. For more complex or larger projects, delivery times may vary.", faqQ2: "What are the max print dimensions?", faqA2: "Our largest volume is 350 x 350 x 350 mm. Larger items would be printed in sections, subject to agreement.", faqQ3: "Can you help with model design?", faqA3: "We can create a model based on a technical drawing or photograph (ideally accompanied by dimensions).", faqQ4: "How do you protect my models from misuse or data leaks?", faqA4: "Your intellectual property is protected with us. Print preparation takes place on a dedicated offline computer, and the printers themselves are physically disconnected from the internet.", footerDesc: "Professional custom 3D printing and modeling.", contactTitle: "Contact Us", socialTitle: "Follow Us",
...
function applyTranslations() {
    ...
    const elements = [
        ...
        'faq-q1', 'faq-a1', 'faq-q2', 'faq-a2', 'faq-q3', 'faq-a3', 'faq-q4', 'faq-a4', 'footer-desc', 'contact-title', 'social-title', 'modal-title', 
